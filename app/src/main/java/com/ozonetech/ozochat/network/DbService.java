...
public class DbService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.ozonetech.ozochat.action.FOO";
    private static final String ACTION_BAZ = "com.ozonetech.ozochat.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "com.ozonetech.ozochat.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "com.ozonetech.ozochat.extra.PARAM2";
...
//            }
    ...
    private void sendUnSendMessage(ArrayList<Message> unsendMsgLsit) {
        for (int i = 0; i < unsendMsgLsit.size(); i++) {
            ...
            Log.d(tag, "- time id  :" + message.getCreated());
            try {
    ...
    private void updateunsendMessage(Message message) {
        ...
        chatDatabase.getInstance(this).chatMessageDao().delete(message);
    }
    /**

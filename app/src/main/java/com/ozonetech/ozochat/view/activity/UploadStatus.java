        ...
        protected void onPostExecute(String result) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent mIntent = new Intent(UploadStatus.this, PhotoVideoRedirectActivity.class);
            ...
            imgCapture.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isSpaceAvailable()) {
                        ...
                        Toast.makeText(UploadStatus.this, "Memory is not available", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
            ...
            public void run() {
                if (videopath != null) {
                    ...
                    if (fileSizeInMB > MAX_VIDEO_SIZE_UPLOAD) {
                        new AlertDialog.Builder(UploadStatus.this)
        ...
        mediaRecorder.setOnInfoListener(new MediaRecorder.OnInfoListener() {
            ...
            public void onInfo(MediaRecorder mr, int what, int extra) {
                ...
                if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED) {
                    ...
                    Toast.makeText(UploadStatus.this, "You reached to Maximum(25MB) video size.", Toast.LENGTH_SHORT).show();
                }
